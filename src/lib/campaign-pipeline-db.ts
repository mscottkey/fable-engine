...
export async function getLatestPhase3Factions(
  ...
  try {
    ...
    return {
      success: true,
      data: {
        factions: result.factions_json as Phase3Output['factions'],
        relationships: result.relationships as Phase3Output['relationships'],
        fronts: (result.fronts || []) as Phase3Output['fronts'],
      },
