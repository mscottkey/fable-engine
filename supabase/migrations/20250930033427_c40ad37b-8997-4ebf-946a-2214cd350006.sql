...
CREATE INDEX ON public.game_invites (game_id);
...
CREATE INDEX ON public.party_slots (game_id);
...
CREATE INDEX ON public.character_seeds (game_id);
CREATE INDEX ON public.character_seeds (slot_id);
...
CREATE INDEX ON public.game_members (game_id);
