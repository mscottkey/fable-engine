...
CREATE INDEX IF NOT EXISTS idx_games_deleted_at ON public.games (deleted_at) WHERE deleted_at IS NOT NULL;
...
CREATE INDEX IF NOT EXISTS idx_campaign_seeds_deleted_at ON public.campaign_seeds (deleted_at) WHERE deleted_at IS NOT NULL;
